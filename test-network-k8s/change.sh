...
awk -v org_name="$ORG_NAME" '{gsub(/XYZ/, org_name)}1' /workspaces/fabric-samples/test-network-k8s/predefinedOrg/org/org-ca.yaml > /workspaces/fabric-samples/test-network-k8s/kube/${ORG_NAME}/${ORG_NAME}-ca.yaml
...
#k8s builder file
awk -v org_name="$ORG_NAME" '{gsub(/XYZ/, org_name)}1' /workspaces/fabric-samples/test-network-k8s/predefinedOrg/org/org-install-k8s-builder.yaml > /workspaces/fabric-samples/test-network-k8s/kube/${ORG_NAME}/${ORG_NAME}-install-k8s-builder.yaml
...
#org peer1 file
awk -v org_name="$ORG_NAME" '{gsub(/XYZ/, org_name)}1' /workspaces/fabric-samples/test-network-k8s/predefinedOrg/org/org-peer1.yaml > /workspaces/fabric-samples/test-network-k8s/kube/${ORG_NAME}/${ORG_NAME}-peer1.yaml

#org peer2 file
awk -v org_name="$ORG_NAME" '{gsub(/XYZ/, org_name)}1' /workspaces/fabric-samples/test-network-k8s/predefinedOrg/org/org-peer2.yaml > /workspaces/fabric-samples/test-network-k8s/kube/${ORG_NAME}/${ORG_NAME}-peer2.yaml
